...
class Calendar extends Component {
    ...
    openPopupForm = (slotInfo) => {
        ...
        let detailsChange = function (value) {
            slotInfo.details = value;
        };
        ...
        Popup.create({
            ...
            content: <div>
                        ...
                        <Input onChange={detailsChange} placeholder="Event Details" defaultValue={slotInfo.details} />
                    </div>,
            buttons: {
                left: ['cancel'],
                right: [{
